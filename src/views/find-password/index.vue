	...
	<div class="find_password">
		...
		<div class="info_box p2" v-if="process">
			<div class="mobile">
				...
				<input type="text" v-model="mobile" placeholder="请输入注册手机号" class="mobile_input">
			</div>
			<div class="code">
				<icon name="iconmima" class="fz20 code_icon mt1"></icon>
		...
		<div class="password">
			<icon name="iconmima" class="fz20 mobile_icon mt1"></icon>
			<input
			type="password"
			v-model="password"
